    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-8 space-y-6">
          ...
          ) : (!events || events.length === 0) && (!notices || notices.length === 0) ? (
            <div className="py-16 text-center">
              <Megaphone className="mx-auto size-10 text-muted-foreground/50" />
              <p className="mt-4 text-muted-foreground">No active campaigns or donation events right now.</p>
              <p className="mt-1 text-xs text-muted-foreground">Check back later for upcoming drives and notices.</p>
            </div>
          ) : (
